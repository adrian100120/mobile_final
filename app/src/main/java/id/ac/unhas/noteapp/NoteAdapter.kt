...
import id.ac.unhas.noteapp.databinding.ItemNoteBinding
        ...
        fun bind(note: Note) {
            ...
            binding.cvItemNote.setOnClickListener(CustomOnItemClickListener(adapterPosition, object : CustomOnItemClickListener.OnItemClickCallback {
                override fun onItemClicked(view: View, position: Int) {
                    ...
                    intent.putExtra(NoteDetailActivity.EXTRA_POSITION, position)
                    intent.putExtra(NoteDetailActivity.EXTRA_NOTE, note)
                    activity.startActivityForResult(intent, NoteDetailActivity.REQUEST_UPDATE)
                }
            }))
        }
    }
